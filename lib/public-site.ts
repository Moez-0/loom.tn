...
function normalizeEditorConfig(value: unknown): PublicSiteEditorConfig {
  ...
  return {
    ...
    architect_show_grid_lines: raw.architect_show_grid_lines === false ? false : true,
    architect_show_shapes: raw.architect_show_shapes === false ? false : true,
    architect_motion_intensity:
      raw.architect_motion_intensity === 'subtle' || raw.architect_motion_intensity === 'high'
        ? raw.architect_motion_intensity
        : 'medium',
    architect_contact_layout: raw.architect_contact_layout === 'stacked' ? 'stacked' : 'split',
    architect_contact_highlight: toNullableText(raw.architect_contact_highlight),
    architect_projects_label: toNullableText(raw.architect_projects_label),
    architect_projects_value: toNullableText(raw.architect_projects_value),
    architect_years_label: toNullableText(raw.architect_years_label),
    architect_years_value: toNullableText(raw.architect_years_value),
    architect_disciplines_label: toNullableText(raw.architect_disciplines_label),
    architect_disciplines_value: toNullableText(raw.architect_disciplines_value),
    architect_process_title: toNullableText(raw.architect_process_title),
    architect_process_step1_title: toNullableText(raw.architect_process_step1_title),
    architect_process_step1_description: toNullableText(raw.architect_process_step1_description),
    architect_process_step2_title: toNullableText(raw.architect_process_step2_title),
    architect_process_step2_description: toNullableText(raw.architect_process_step2_description),
    architect_process_step3_title: toNullableText(raw.architect_process_step3_title),
    architect_process_step3_description: toNullableText(raw.architect_process_step3_description),
